...
def test_rank_relationships_returns_top_ranked_people():
    profile = {
        "relationship_signals": [
            {"name": "Priya", "status": "drifted", "context": "We used to talk daily.", "mention_count": 5},
            {"name": "Rahul", "status": "active", "context": "Spoke last week.", "mention_count": 3},
            {"name": "Neha", "status": "drifted", "context": "Haven't spoken in months.", "mention_count": 2},
        ]
    }
