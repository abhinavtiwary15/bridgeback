...
CORS_ORIGINS: str = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:8501")
...
CRISIS_KEYWORDS = [
    ...
    "no one would care", "nobody would miss me",
]
...
MIN_ACTIONS_BEFORE_RETURN: int = 1     # user must complete ≥ N actions before re-opening app
