...
_DRIFT_MARKERS = [
    r"we used to",
    r"haven'?t (spoken|talked|seen|heard from)",
    r"lost touch",
    r"drifted",
    r"not as close",
    r"a long time ago",
...
_ANXIETY_MARKERS = [
    r"too anxious",
    r"too scared",
    r"afraid to reach out",
    r"don'?t know what to say",
    r"might reject",
    r"awkward",
    r"nervous about",
    r"can'?t bring myself",
]
...
def _bert_score(text: str) -> Optional[int]:
    ...
    try:
        ...
        anchor_lonely = (
            "I feel very lonely and have no one to talk to or spend time with."
        )
